...
model_path = 'C:\\Users\\Hp\\Documents\\AI_ML Bootcamp\\Student_Performance_Analysis\\ML_Model\\knn_model.pkl'
model = joblib.load(model_path)

# Extract features names from the model if they are available
try:
...
def main():
    ...
    # add a desription
    st.write('Enter student information to predict pass/fail.')

    # Create columns for a layout
    col1, col2 = st.columns([2,1])

    with col1:
        st.subheader('Student Information')

        # Add input fields for featueres
        ...
        famsize = st.selectbox("Family Size",['3 or less','More then 3'])
        ...
        traveltime = st.slider("Traveltime to School (Minutes)",1,4,2)
        ...
        famrel = st.slider("Family Relationship Quality",1,4,2)
